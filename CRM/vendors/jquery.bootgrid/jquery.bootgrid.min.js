    ...
    */
    ...
    function loadData()
    {
        ...
        else
        {
            ...
            if(this.onlySelected){
                var rows = this.selectedRows.map(function(a){
                    return that.rows.filter(function(b){
                        return a == b.id;
                    })[0]
                })
            }
            rows = (this.searchPhrase.length > 0) ? rows.where(containsPhrase) : rows;
    ...
    function renderActions()
    {
        if (this.options.navigation !== 0)
        {
            ...
            if (actionItems.length > 0)
            {
                ...
                {
                    var addIcon = $(tpl.addButton.resolve(getParams.call(this,{ text: 'Add' })))
                            .on("click" + namespace, function (e){
                                that.options.addClicked();
                            });
                    actions.append(addIcon);
                }

                // Reload Button
                if (this.options.reloadBtn)
                {
                    var reloadIcon = $(tpl.reloadBtn.resolve(getParams.call(this,{ text: '' })))
                            .on("click" + namespace, function (e){
                                that.options.reloadClicked();
                            });
                    actions.append(reloadIcon);
                }
    ...
    Grid.defaults = {
        ...
        css: {
            ...
            selectCell: "select-cell crm-checkbox", // must be a unique class name or constellation of class names within the entire table
